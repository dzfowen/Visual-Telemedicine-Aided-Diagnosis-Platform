...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_audioRecordThread_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 44, 3)
    ...
    "audioRecordThread\0sendAudioBufferMsg\0"
    "\0CHAR*\0buf"
};
...
void audioRecordThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        audioRecordThread *_t = static_cast<audioRecordThread *>(_o);
        switch (_id) {
        case 0: _t->sendAudioBufferMsg((*reinterpret_cast< CHAR*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (audioRecordThread::*_t)(CHAR * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&audioRecordThread::sendAudioBufferMsg)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject audioRecordThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_audioRecordThread.data,
      qt_meta_data_audioRecordThread,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_audioRecordThread.stringdata))
        return static_cast<void*>(const_cast< audioRecordThread*>(this));
...
// SIGNAL 0
void audioRecordThread::sendAudioBufferMsg(CHAR * _t1)
{
