...
QT_MOC_LITERAL(5, 42, 22)
    ...
    "audioThread\0sendAudioBufferMsg\0\0CHAR*\0"
    "buf\0sendAudioBufferMsgCopy"
};
...
void audioThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->sendAudioBufferMsgCopy((*reinterpret_cast< CHAR*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (audioThread::*_t)(CHAR * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&audioThread::sendAudioBufferMsg)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void audioThread::sendAudioBufferMsg(CHAR * _t1)
{
